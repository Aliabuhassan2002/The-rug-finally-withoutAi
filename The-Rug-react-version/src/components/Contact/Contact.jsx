...
//   return (
// <div class="grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6 bg-white font-[sans-serif] pt-40">
//       <div class="px-4">
...
//               <p class="text-sm mt-4">Ali@gmail.com</p>
//             </div>
//           </div>
...
//               <p class="text-sm mt-4">26st. New Zarqa</p>
//             </div>
//           </div>
...
//               <p class="text-xs mt-1 text-gray-500">24/7</p>
//               <p class="text-sm mt-4">+962787507215</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
//         <h2 class="text-xl text-yellow-300 font-semibold">Product or Service Inquiry</h2>
//         <p class="text-sm text-gray-400 mt-2 leading-relaxed">Have some big issue and need help? Then reach out we'd love to hear about your problem and provide help.</p>
